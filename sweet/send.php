...
if ($client_name != '') {
  $post_subject .= ', ' . $client_name;
}    // добавляем имя в тему письма
if ($client_mail != '') {
  $post_subject .= ', ' . $client_mail;
}    // добавляем email в тему письма
if ($client_phone != '') {
  $post_subject .= ', ' . $client_phone;
}  // добавляем телефон/скайп в тему письма
...
if ($client_name != '') {
  $post_message .= '<tr><td style="border: 1px solid #f9f1f1; padding: 5px 20px;">Имя: </td><td style="border: 1px solid #f9f1f1; padding: 5px 20px;">' . $client_name . '</td></tr>';
}
if ($client_mail != '') {
  $post_message .= '<tr><td style="border: 1px solid #f9f1f1; padding: 5px 20px;">E-mail: </td><td style="border: 1px solid #f9f1f1; padding: 5px 20px;">' . $client_mail . '</td></tr>';
}
if ($client_phone != '') {
  $post_message .= '<tr><td style="border: 1px solid #f9f1f1; padding: 5px 20px;">Телефон/скайп: </td><td style="border: 1px solid #f9f1f1; padding: 5px 20px;">' . $client_phone . '</td></tr>';
}
if ($form_name != '') {
  $post_message .= '<tr><td style="border: 1px solid #f9f1f1; padding: 5px 20px;">Название формы: </td><td style="border: 1px solid #f9f1f1; padding: 5px 20px;">' . $form_name . '</td></tr>';
}
if ($page_name != '') {
  $post_message .= '<tr><td style="border: 1px solid #f9f1f1; padding: 5px 20px;">Название страницы: </td><td style="border: 1px solid #f9f1f1; padding: 5px 20px;">' . $page_name . '</td></tr>';
}
if ($select != '') {
  $post_message .= '<tr><td style="border: 1px solid #f9f1f1; padding: 5px 20px;">Название Услуги: </td><td style="border: 1px solid #f9f1f1; padding: 5px 20px;">' . $select . '</td></tr>';
}
if ($check != '') {
  $post_message .= '<tr><td style="border: 1px solid #f9f1f1; padding: 5px 20px;">Меня заинтересовали: </td><td style="border: 1px solid #f9f1f1; padding: 5px 20px;">' . $check . '</td></tr>';
}
$post_message .= '
</table>
</body>

    ...
    <div class="wr row">
        <div class="content column">
            ...
            <? } else { ?>
                ...
                <p class="garanty">Из-за некорректного заполнения полей формы заявка не отправлена и не будет обработана. Рекомендуем Вам связаться с представителями компании другим способом.</p>
                <a href="/" class="btn">вернуться на главную</a>
            <?php } ?>
        </div>
        <div class="content column">
